...
class BugsenseEnvironment {
    ...
    static function to_array() {
        if (!self::$environment) {
			...
			$client = array(
                  "name" => Bugsense::$client_name,
                  "version" => Bugsense::$version,
                  "protocol_version" => Bugsense::$protocol_version
            );
            ...
            self::$environment =  array(
                ...
                "application_environment" => array(
				  "headers" => array(),
				  "appver" => Bugsense::$app_version,
				  "appid" => "2",
                  "environment" => Bugsense::$environment,
                  //"env" => $env,
